...
<center>
	...
	<br/>
	<br/>
	<h4 class="light-blue uppercase" style="letter-spacing: 2px">create a new comedy group</h4>
	</br>
</center>
...
<div class="login-form-wrap">
	<form action="create_group.php" method="post">
		<div class="grid-container">
			<div class="grid-row">
				<div class="col-10"><label for="name"><strong>Comedy Group Name: </strong></label></div>
			</div>
			<div class="grid-row">
		...
		<input type="hidden" name="group_type" value=3 />
